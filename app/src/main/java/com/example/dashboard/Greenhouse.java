...
public class Greenhouse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calendarView1 = (CalendarView) findViewById(R.id.calendarView2);
        myDate1 = (TextView) findViewById(R.id.myDate2);
        btn1 = (Button)findViewById(R.id.mybutton2);
        mydaten1 = findViewById(R.id.my_date2);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                referencen1 = rootNoden1.getReference("greenhouse");
