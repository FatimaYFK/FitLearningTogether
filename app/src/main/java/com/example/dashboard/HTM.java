...
public class HTM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_h_t_m);
        calendarView1 = (CalendarView) findViewById(R.id.calendarView3);
        myDate1 = (TextView) findViewById(R.id.myDate3);
        btn1 = (Button)findViewById(R.id.mybutton3);
        mydaten1 = findViewById(R.id.my_date3);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                referencen1 = rootNoden1.getReference("htm");
