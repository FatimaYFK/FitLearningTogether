package com.example.dashboard.weather.view.ui;
...
import com.example.dashboard.weather.viewModel.WeatherInfoViewModel;
            ...
            public void onChanged(DataModel dataModel) {
                ...
                if (dataModel != null && result) {
                    ...
                    if ((temperature_current != null && !temperature_current.isEmpty()) && (location != null && !location.isEmpty()) && (sunRise != null && !sunRise.isEmpty()) &&
                        ...
                        Glide.with(ActivityWeather.this).load(imageUrl).into(iv_WeatherIcon);
